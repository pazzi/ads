/*2. Construa uma função em linguagem C que receba três parâmetros: um
...
operação de INTERSECÇÃO (como definida na teoria dos conjuntos) entre as
listas apontadas por inicio1 e inicio2, guardando o resultado na lista
apontada por inicio3. Para recordar, a intersecção de conjuntos corresponde
aos elementos que se repetem nos conjuntos dados.
*/
#include <stdio.h>
#include <stdlib.h>
#include <stdio.h>
...
int main()
{
  ...
  printf("--------------------------------------------------------------------------\n");
  printf("           Questao 2 - Interceccao entre 2 conjuntos\n");
  printf("--------------------------------------------------------------------------\n");
...
///  printf("\n\nItens na lista2: %ld\n",contaLista(inicio2));
  ...
  faz_Interseccao( inicio1, inicio2, &inicio3);
  ordenar(&inicio3);
//  imprime(inicio3);
  ...
  imprime(inicio3);
  printf("\n\nItens na lista3 apos eliminar duplicados: %ld\n",contaLista(inicio3));
  printf("\n\n\n --------------------------------F I M-------------------------------------------\n\n");
